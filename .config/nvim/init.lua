--  ===================================================================================
--  Copy-pasted from https://github.com/nvim-lua/kickstart.nvim
--  TODO: Read about lazy.nvim. 
--  ===================================================================================
...
vim.keymap.set('n', '<leader>vt', '<C-w>v:term<Enter>' , { desc = ':vert term' })

-- from: http://vimcasts.org/episodes/neovim-terminal-mappings/
-- press <C-n> in a :term buffer to go to normal mode
vim.keymap.set('t', '<C-n>', '<C-\\><C-n>',      {desc='term-to-normal-mode'})
-- use <C-w>{h,j,k,l} in a :term buffer to switch to another window
vim.keymap.set('t', '<C-w>l', '<C-\\><C-n><C-w>l', {desc='term-right'})
vim.keymap.set('t', '<C-w>h', '<C-\\><C-n><C-w>h', {desc='term-left'})
vim.keymap.set('t', '<C-w>k', '<C-\\><C-n><C-w>k', {desc='term-up'})
vim.keymap.set('t', '<C-w>j', '<C-\\><C-n><C-w>j', {desc='term-down'})
